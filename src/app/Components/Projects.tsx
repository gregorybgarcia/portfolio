...
export default function Projects() {
  ...
  const companyCardStyle = "p-4 hover:bg-gray-300 hover:rounded-md hover:cursor-pointer ease-in duration-300"
  ...
  return (
    <div
      className="bg-violet-900 z-10 flex-col w-full sm:h-screen"
      id="projects"
    >
      <div className="bg-gray-800 flex items-center p-6 sm:h-2/4 sm:pb-44">
        <div className="mx-auto my-0 text-center">
          <h2 className="text-4xl font-bold mb-6 sm:text-6xl">
            My Recent Work
          </h2>
      ...
      <motion.div
        ...
        className="bg-gray-100 mx-auto my-0 rounded-xl text-center text-gray-800 p-6 grid grid-cols-1 text-center sm:w-4/6 sm:grid-cols-3 sm:-mt-44"
      >
        <div className={companyCardStyle} onClick={() => window.open("https://incentiv.me")}>
          <img
        ...
        <div className={companyCardStyle} onClick={() => window.open("https://www.santander.com/en/about-us/where-we-are/pagonxt")}>
          <img
            className="rounded-xl mx-auto my-0"
            width="160"
            height="160"
        ...
        <div className={companyCardStyle} onClick={() => window.open("https://www.qyon.com/en")}>
          <img
            className="rounded-xl mx-auto my-0"
            width="160"
            height="160"
      ...
      <p className="font-bold text-6xl p-6 text-center sm:mt-6">
        Let's work together!
      </p>
    </div>
  );
